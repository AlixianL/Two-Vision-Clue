...
public class SimonsManager : MonoBehaviour
{
    ...
    private int _placeTocheckSequence = 0;//----------------------------------------> place qui doit �tre verifier dans la liste

    private bool _enigmaIsEnd = false;//--------------------------------------------> bool�en pour verifier si l'enigme est finit
    private bool _enigmaIsOn = false;//---------------------------------------------> bool�en pour verifier si l'enigme est lanc�
    ...
    void EndEnigme()
    {
       ...
       Debug.Log("Enigme Simon Fini");
        ...
        SaveData.Instance.gameData.simonEnigmaIsComplete = true;
